...
namespace TestProject1.Pages
{
    class ImportUsersPage : DriverHelper
    {
        ...
        //public IWebElement ImportUsersButton => Driver.FindElement(By.XPath("/html/body/app-root/app-admin-layout/div/section[1]/div/ng-component/div[2]/div/div/div[2]/permission-block[3]/div/upload-media/div/label/button/em"));
        //public IWebElement ImportUsersButton => Driver.FindElement(By.XPath("/html/body/app-root/app-dashboard/div/section[1]/div/ng-component/div[2]/div/div/div[2]/permission-block[3]/div/upload-media/div/label/button"));
