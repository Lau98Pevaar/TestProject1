...
namespace TestProject1.Pages
{
    class CreateSubscriptionPage : DriverHelper
    {
        ...
        public IWebElement TxtDescription => Driver.FindElement(By.XPath("//div[@class='ql-editor ql-blank']"));
        
        public IWebElement EffectiveDateBtn => Driver.FindElement(By.XPath("/html/body/app-root/app-admin-layout/div/section[1]/div/edit-subscription/content-loader/div/div/div/div/form/div[4]/div[1]/div/synapze-cx-form-control/synapze-cx-calendar/form/p-calendar/span/button"));
        ...
        public IWebElement TimeUnitFrecuencyDropdown => Driver.FindElement(By.XPath("/html/body/app-root/app-admin-layout/div/section[1]/div/edit-subscription/content-loader/div/div/div/div/form/div[4]/div[3]/div/div[2]/synapze-cx-form-control/subscription-period-unit-selector/form/div/synapze-cx-simple-dropdown/form/p-dropdown/div/div[3]"));
        ...
        public IWebElement SelectOpMod => Driver.FindElement(By.XPath("/html/body/modal-container/div/div/div[2]/select-modules/content-loader/div/synapze-cx-grid/div/table/tbody/tr[1]/label/div"));
